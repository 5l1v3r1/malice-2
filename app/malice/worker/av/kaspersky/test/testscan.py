...
from app.malice.worker.av.generic.test.common import AVEngineTemplate, EvilnessEngineTemplate
from lib.scanworker.file import PickleableFileSample

class TestKasperskyAV(AVEngineTemplate, EvilnessEngineTemplate, unittest.TestCase):
