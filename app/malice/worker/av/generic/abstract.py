...
from app.malice.worker.av.generic.exception import ScannerRequiresLicenseFile
from app.malice.worker.av.generic.result import GenericEvilnessResult, GenericMDResult
...
class AbstractEvilnessEngine(AbstractEngine):
    ...
    def do_scan(self, file_object):
        ...
        parsed_scan_object = GenericEvilnessResult(file_object.digest, infected=infected,
                                                   infected_string=infected_string, metadata=metadata)
