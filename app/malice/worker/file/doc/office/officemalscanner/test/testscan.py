...
from app.malice.worker.av.officemalscanner.scanner import officemalscanner_engine
from app.malice.worker.av.generic.test.common import PickyEngineTemplate, EvilnessEngineTemplate
