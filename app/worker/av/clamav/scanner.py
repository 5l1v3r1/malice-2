...
from file import pyclamd
from app.worker.av.generic.abstract import AbstractEvilnessEngine, L32_PLATFORM
from app.worker.av.generic.exception import ScannerConnectionError, ScannerUpdateError
    ...
    def update_definitions(self):
        ...
        try:
            ...
            if e.output.find("ERROR: /var/log/clamav/freshclam.log is locked by another process") != -1:
                print "WARNING: freshclam failed to get a lock on update files.  Trying again in {0}s...".format(
                    self._retry_timeout)
