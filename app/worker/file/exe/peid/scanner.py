...
import math
import tempfile
from app.worker.av.generic.abstract import AbstractMDEngine, L32_PLATFORM
from app.worker.av.generic.exception import UnsupportedFileTypeForScanner
...
class peid_engine(AbstractMDEngine):
	...
	def _build_peid_matches(self, scan_result):
		import peutils
		pe_matches = dict()
		UserDB_FILE_DIR_PATH = path.join(path.dirname(__file__), 'file', '../pe/data/UserDB.TXT')
